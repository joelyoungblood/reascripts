...
local window = rtk.Window{borderless=true, bg='#232323', h=507, w=457, x=433, y=764}
...
local function main()
    ...
    app:add_screen(Menu.CreateMainScene(types, '#ECC170', 'core', window, true, close, back), 'coreFXMenu')
    window:open()
end
